// Crie a função recursiva balanceada(v,p,u), que devolve uma árvore binária balanceada
// com os itens do vetor v, cujo primeiro item está na posição u e cujo último item está na posição u.
