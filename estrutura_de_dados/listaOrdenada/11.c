...
Crie a função recursiva osc(L), que verifica se L é uma lista ordenada de forma
simplesmente crescente (i.e., cada item é menor ou igual ao item seguinte na
lista).*/
